CPP = gcc
CPP_OPTIONS = -nostdlib -fno-builtin -nostartfiles -nodefaultlibs -fno-exceptions -fno-rtti -fno-stack-protector -fleading-underscore -m32 -fno-asynchronous-unwind-tables
...
threads.o: thread.C thread.H threads_low.H
	$(CPP) $(CPP_OPTIONS) -c -o threads.o thread.C

scheduler.o: scheduler.C scheduler.H
	$(CPP) $(CPP_OPTIONS) -c -o scheduler.o scheduler.C

queue.o: queue.C queue.H
	$(CPP) $(CPP_OPTIONS) -c -o queue.o queue.C
...
kernel.bin: start.o utils.o kernel.o assert.o console.o gdt.o idt.o irq.o machine.o exceptions.o interrupts.o \
   simple_timer.o simple_disk.o frame_pool.o mem_pool.o threads_low.o threads.o scheduler.o queue.o blocking_disk.o
	ld -melf_i386 -T linker.ld -o kernel.bin start.o utils.o kernel.o assert.o console.o gdt.o idt.o \
   exceptions.o irq.o machine.o interrupts.o simple_timer.o simple_disk.o frame_pool.o threads_low.o threads.o mem_pool.o scheduler.o queue.o blocking_disk.o
